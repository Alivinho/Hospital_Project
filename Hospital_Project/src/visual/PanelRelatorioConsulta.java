...
public class PanelRelatorioConsulta extends JPanel {
	...
	private JLabel lblTipoDeConsulta_1;
	...
	private JPanel getPanelDadosPessoais() {
		if (panelDadosPessoais == null) {
			...
			panelDadosPessoais.add(getLblTipoDeConsulta_1());
	...
	private JLabel getLblTipoDeConsulta_1() {
		if (lblTipoDeConsulta_1 == null) {
			lblTipoDeConsulta_1 = new JLabel("Tipo de Consulta");
			lblTipoDeConsulta_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
			lblTipoDeConsulta_1.setBounds(269, 10, 128, 32);
		}
		return lblTipoDeConsulta_1;
	}
	private JComboBox getComboBox_1() {
		if (comboBox_1 == null) {
			comboBox_1 = new JComboBox();
			comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Selelcione um tipo de Consulta"}));
