...
public class ControladorRelatorioConsulta implements ActionListener {
	...
	public void gerarRelatorioConsulta() {
		try {	
	        ...
	        JOptionPane.showMessageDialog(panelRelatorioConsulta, "[SUCESSO ✅ ]:Relatorio gerado com sucesso!", "Sucesso!", JOptionPane.INFORMATION_MESSAGE);
            limparCampos();
			
			
		} catch (Exception e) {
			JOptionPane.showMessageDialog(panelRelatorioConsulta, "[ERRO ❌ ]: " + e.getMessage(), "Erro", JOptionPane.WARNING_MESSAGE);
